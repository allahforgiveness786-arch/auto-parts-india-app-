...
export default function AdminTaxonomyCMS({
  ...
  const handleSeedStandardTaxonomy = () => {
    setConfirmModal({
      ...
      message: "This will populate standard Indian categories, car brands, models, states, and districts into app configuration. Continue?",
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          await loadTaxonomy();
          showToast("Standard Automotive Taxonomy successfully updated!");
        } catch (err: any) {
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 border-b border-slate-100 pb-3">
          <div>
            ...
            <p className="text-[11px] text-slate-500 mt-0.5">
              Manage categories, brands, models, variants, spare parts, and locations in real-time.
            </p>
          </div>
