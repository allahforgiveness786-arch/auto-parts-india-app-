...
export default function AdminDashboardScreen({
  ...
  const handleDeleteBanner = (b: Banner) => {
    setConfirmModal({
      ...
      message: `Are you sure you want to permanently delete "${b.title}"? This cannot be undone.`,
  ...
  const handlePermanentDelete = async (part: SparePart) => {
    setConfirmModal({
      ...
      message: `Are you sure you want to permanently delete "${part.title}"? This action cannot be undone.`,
      ...
      onConfirm: async () => {
        try {
          ...
          if (success) {
            showToast(`Listing "${part.title}" deleted successfully.`);
  ...
  const handleBulkAction = async (action: "delete") => {
    ...
    if (action === "delete") {
      setConfirmModal({
        ...
        message: `Are you sure you want to permanently delete ${selectedPartIds.length} listing(s)? This action cannot be undone.`,
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {activeTab === "users" && (
          <div className="space-y-4">
            {/* User Directory Count Status Banner */}
            <div id="users-status-banner" className="bg-blue-50/90 border border-blue-200 rounded-2xl p-3.5 flex flex-wrap items-center justify-between gap-2 text-xs font-semibold text-blue-900 shadow-xs">
              <div className="flex items-center gap-2">
                <span className="text-blue-600 font-bold uppercase tracking-wider text-[10px]">Registered Users:</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-300 font-medium">
                    Manage promotional hero banners, upload image assets, and set display ordering in real-time.
                  </p>
                </div>
              </div>
              <button
            ...
            {loadingBanners ? (
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-100 text-center space-y-3">
                ...
                <p className="text-[11px] text-slate-500 max-w-sm mx-auto">
                  No promotional banners have been added yet. Click the button below to create your first banner!
                </p>
                <button
                  onClick={handleOpenAddBanner}
              ...
              <div className="flex justify-between items-center border-b border-slate-50 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400">Manage release metadata and update alerts</p>
                  </div>
                </div>
